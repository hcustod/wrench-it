-- V16__fix_view_store_rating_summary_round.sql
-- Recreate v_store_details with rounded avg_rating, and aggregated services list
...
SELECT
  ...
  -- Keep it numeric-looking but same type as before (double precision) to avoid type-change errors
